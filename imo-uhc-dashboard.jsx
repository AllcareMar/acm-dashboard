...
// ── STATE-LEVEL BOB ──
const BOB={AL:{m:130,a:6}, AZ:{m:148,a:10}, CA:{m:53,a:8}, CO:{m:427,a:22}, CT:{m:452,a:19}, DE:{m:274,a:16}, FL:{m:4107,a:78}, GA:{m:60,a:7}, KS:{m:1,a:1}, LA:{m:96,a:5}, MA:{m:1,a:1}, MD:{m:1,a:1}, MI:{m:109,a:12}, NC:{m:1292,a:30}, NJ:{m:6686,a:101}, NY:{m:405,a:29}, OH:{m:379,a:16}, PA:{m:2747,a:55}, PR:{m:2,a:1}, RI:{m:416,a:12}, SC:{m:49,a:7}, TN:{m:41,a:9}, TX:{m:3246,a:60}, VA:{m:497,a:18}, WI:{m:6,a:2}};
...
const AGENCY_DATA = {
  "AllCare Mar": {
    total:8421, uniqueAgents:75,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "LA", "MI", "NC", "NJ", "NY", "OH", "PA", "RI", "SC", "TN", "TX", "VA"],
    bobState:{AL:{m:97,a:3}, AZ:{m:42,a:3}, CA:{m:26,a:5}, CO:{m:50,a:4}, CT:{m:174,a:9}, DE:{m:230,a:9}, FL:{m:1028,a:35}, GA:{m:6,a:4}, LA:{m:69,a:2}, MI:{m:50,a:6}, NC:{m:390,a:15}, NJ:{m:3871,a:59}, NY:{m:164,a:19}, OH:{m:2,a:1}, PA:{m:1123,a:19}, RI:{m:19,a:3}, SC:{m:12,a:4}, TN:{m:16,a:5}, TX:{m:639,a:15}, VA:{m:413,a:11}},
  ...
  "Concep Care": {
    total:5373, uniqueAgents:25,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "MI", "NC", "NJ", "OH", "PA", "RI", "SC", "TN", "TX", "VA", "WI"],
    bobState:{AL:{m:21,a:2}, AZ:{m:12,a:3}, CA:{m:25,a:2}, CO:{m:154,a:11}, CT:{m:157,a:5}, DE:{m:20,a:2}, FL:{m:1769,a:21}, GA:{m:54,a:3}, MI:{m:29,a:3}, NC:{m:475,a:8}, NJ:{m:951,a:19}, OH:{m:207,a:6}, PA:{m:247,a:14}, RI:{m:298,a:4}, SC:{m:16,a:2}, TN:{m:25,a:4}, TX:{m:852,a:15}, VA:{m:58,a:6}, WI:{m:3,a:1}},
  ...
  "GW Ins Group": {
    total:1726, uniqueAgents:13,
    states:["AZ", "CT", "DE", "FL", "NC", "NJ", "NY", "OH", "PA", "PR", "SC", "TX", "VA"],
    bobState:{AZ:{m:92,a:3}, CT:{m:72,a:3}, DE:{m:8,a:2}, FL:{m:548,a:9}, NC:{m:28,a:2}, NJ:{m:580,a:9}, NY:{m:25,a:4}, OH:{m:95,a:4}, PA:{m:101,a:6}, PR:{m:2,a:1}, SC:{m:12,a:1}, TX:{m:139,a:6}, VA:{m:24,a:3}},
  ...
  "Simarova Senior": {
    total:1590, uniqueAgents:10,
    states:["AZ", "CO", "CT", "FL", "LA", "MD", "MI", "NC", "NJ", "OH", "PA", "RI", "TX", "VA", "WI"],
    bobState:{AZ:{m:2,a:1}, CO:{m:189,a:6}, CT:{m:19,a:3}, FL:{m:417,a:7}, LA:{m:6,a:1}, MD:{m:1,a:1}, MI:{m:9,a:2}, NC:{m:150,a:5}, NJ:{m:17,a:5}, OH:{m:64,a:4}, PA:{m:95,a:5}, RI:{m:99,a:5}, TX:{m:517,a:8}, VA:{m:2,a:2}, WI:{m:3,a:1}},
  ...
  "KMRA Group": {
    ...
    bobState:{DE:{m:1,a:1}, FL:{m:9,a:4}, MA:{m:1,a:1}, NJ:{m:448,a:8}, PA:{m:686,a:8}, TX:{m:26,a:1}},
  ...
  "Martell Multi": {
    total:1048, uniqueAgents:10,
    states:["KS", "NJ", "NY", "PA", "TX"],
    bobState:{KS:{m:1,a:1}, NJ:{m:493,a:10}, NY:{m:1,a:1}, PA:{m:394,a:3}, TX:{m:159,a:2}},
  ...
  "TCS & Associates": {
    total:936, uniqueAgents:14,
    states:["FL", "LA", "NC", "NJ", "TX"],
    bobState:{FL:{m:315,a:6}, LA:{m:12,a:2}, NC:{m:34,a:2}, NJ:{m:31,a:6}, TX:{m:544,a:12}},
...
function BobBadge(){
  return(
    <div style={{display:"inline-flex",alignItems:"center",gap:5,background:"#1a0f2e",border:"1px solid #8b5cf655",borderRadius:6,padding:"4px 10px",fontSize:10,color:"#c4b5fd"}}>
      📊 <strong style={{color:"#a78bfa"}}>BOB REAL</strong>  ·  21,625 policies  ·  776 counties  ·  4,275 zips  ·  06-23-2026
    </div>
  );
}
      ...
      {open && (
        <div style={{position:"absolute",top:"calc(100% + 6px)",left:0,background:"#0c1222",border:"1px solid "+UHC_GOLD+"66",borderRadius:10,padding:8,minWidth:280,boxShadow:"0 24px 50px #00000099",zIndex:200}}>
          ...
          >
            ...
            <span style={{marginLeft:"auto",color:"#334155",fontSize:11}}>21,625 policies</span>
          </div>
          {agencies.map(a => (
            <div
              key={a.short}
        ...
        <div style={{background:"linear-gradient(135deg,#001a5e,#002677)",padding:"13px 15px",borderBottom:"2px solid "+mc}}>
          ...
          <div style={{marginTop:10,display:"inline-flex",alignItems:"center",gap:8,background:mc+"22",borderRadius:8,padding:"6px 12px",border:"1px solid "+mc+"44"}}>
            ...
            <div>
              ...
              <div style={{color:"#93c5fd",fontSize:10}}>{mode==="eligible"?"Source: CMS API 2024":"Source: ACM BOB 06-23-2026"}</div>
            </div>
          </div>
        </div>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
          <div style={{display:"flex",alignItems:"center",gap:18}}>
            ...
            <div>
              ...
              <p style={{margin:"3px 0 0",color:"#93c5fd",fontSize:11}}>State Director Presentation  ·  Medicare Advantage  ·  BOB as of 06-23-2026</p>
            </div>
          </div>
      ...
      <div style={{padding:"18px 24px"}}>
        ...
        {tab==="zip"&&(
          <div style={{background:"#0f172a",borderRadius:12,padding:18,border:"1px solid #1e293b"}}>
            ...
            <p style={{color:"#475569",fontSize:12,marginBottom:12}}>Top 20 zip codes per state  ·  Each zip shows its county  ·  Source: ACM_BOB_06-23-2026.xlsx</p>
        ...
        <div style={{marginTop:22,padding:"12px 0",borderTop:"1px solid #0f172a",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:6}}>
          <div style={{display:"flex",flexDirection:"column",gap:3}}>
            <span style={{color:"#94a3b8",fontSize:10}}>📊 BOB: ACM_BOB_06-23-26.xlsx  ·  21,625 active policies  ·  776 counties  ·  134 agents  ·  22 states</span>
