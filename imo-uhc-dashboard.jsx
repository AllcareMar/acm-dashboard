...
// ── DYNAMIC DATE + TOTALS (auto-update each week from latest RETENTION_DATA) ──
const _BOB_SNAPS = RETENTION_DATA.snapshots;
const _BOB_LAST_ISO = _BOB_SNAPS[_BOB_SNAPS.length - 1];
const _BOB_PARTS = _BOB_LAST_ISO.split("-");
const BOB_DATE_DISPLAY = _BOB_PARTS[1] + "-" + _BOB_PARTS[2] + "-" + _BOB_PARTS[0];
const BOB_DATE_FILE = _BOB_PARTS[1] + "-" + _BOB_PARTS[2] + "-" + _BOB_PARTS[0].substring(2);
const _BOB_LAST_GLOBAL = RETENTION_DATA.global[RETENTION_DATA.global.length - 1];
const BOB_TOTAL_POLICIES = _BOB_LAST_GLOBAL ? _BOB_LAST_GLOBAL.total : 0;
const BOB_TOTAL_FORMATTED = BOB_TOTAL_POLICIES.toLocaleString();
...
function BobBadge(){
  return(
    <div style={{display:"inline-flex",alignItems:"center",gap:5,background:"#1a0f2e",border:"1px solid #8b5cf655",borderRadius:6,padding:"4px 10px",fontSize:10,color:"#c4b5fd"}}>
      📊 <strong style={{color:"#a78bfa"}}>BOB REAL</strong>  ·  {BOB_TOTAL_FORMATTED} policies  ·  776 counties  ·  4,275 zips  ·  {BOB_DATE_DISPLAY}
    </div>
  );
}
      ...
      {open && (
        <div style={{position:"absolute",top:"calc(100% + 6px)",left:0,background:"#0c1222",border:"1px solid "+UHC_GOLD+"66",borderRadius:10,padding:8,minWidth:280,boxShadow:"0 24px 50px #00000099",zIndex:200}}>
          ...
          >
            ...
            <span style={{marginLeft:"auto",color:"#334155",fontSize:11}}>{BOB_TOTAL_FORMATTED} policies</span>
          </div>
          {agencies.map(a => (
            <div
              key={a.short}
        ...
        <div style={{background:"linear-gradient(135deg,#001a5e,#002677)",padding:"13px 15px",borderBottom:"2px solid "+mc}}>
          ...
          <div style={{marginTop:10,display:"inline-flex",alignItems:"center",gap:8,background:mc+"22",borderRadius:8,padding:"6px 12px",border:"1px solid "+mc+"44"}}>
            ...
            <div>
              ...
              <div style={{color:"#93c5fd",fontSize:10}}>{mode==="eligible"?"Source: CMS API 2024":"Source: ACM BOB " + BOB_DATE_DISPLAY}</div>
            </div>
          </div>
        </div>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
          <div style={{display:"flex",alignItems:"center",gap:18}}>
            ...
            <div>
              ...
              <p style={{margin:"3px 0 0",color:"#93c5fd",fontSize:11}}>State Director Presentation  ·  Medicare Advantage  ·  BOB as of {BOB_DATE_DISPLAY}</p>
            </div>
          </div>
      ...
      <div style={{padding:"18px 24px"}}>
        ...
        {tab==="zip"&&(
          <div style={{background:"#0f172a",borderRadius:12,padding:18,border:"1px solid #1e293b"}}>
            ...
            <p style={{color:"#475569",fontSize:12,marginBottom:12}}>Top 20 zip codes per state  ·  Each zip shows its county  ·  Source: ACM_BOB_{BOB_DATE_DISPLAY}.xlsx</p>
        ...
        <div style={{marginTop:22,padding:"12px 0",borderTop:"1px solid #0f172a",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:6}}>
          <div style={{display:"flex",flexDirection:"column",gap:3}}>
            <span style={{color:"#94a3b8",fontSize:10}}>📊 BOB: ACM_BOB_{BOB_DATE_FILE}.xlsx  ·  {BOB_TOTAL_FORMATTED} active policies  ·  776 counties  ·  134 agents  ·  22 states</span>
