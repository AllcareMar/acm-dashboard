...
// ── STATE-LEVEL BOB ──
const BOB={AL:{m:128,a:6}, AZ:{m:132,a:11}, CA:{m:50,a:8}, CO:{m:413,a:22}, CT:{m:477,a:20}, DE:{m:266,a:17}, FL:{m:3958,a:75}, GA:{m:59,a:9}, LA:{m:93,a:6}, ME:{m:1,a:1}, MI:{m:99,a:11}, NC:{m:1247,a:34}, NJ:{m:6700,a:103}, NV:{m:2,a:1}, NY:{m:394,a:30}, OH:{m:354,a:16}, PA:{m:2699,a:55}, PR:{m:2,a:1}, RI:{m:417,a:13}, SC:{m:49,a:8}, TN:{m:40,a:9}, TX:{m:3114,a:60}, VA:{m:481,a:21}, WI:{m:6,a:2}};
...
const AGENCY_DATA = {
  "AllCare Mar": {
    total:8306, uniqueAgents:69,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "LA", "MI", "NC", "NJ", "NY", "OH", "PA", "RI", "SC", "TN", "TX", "VA"],
    bobState:{AL:{m:97,a:3}, AZ:{m:33,a:3}, CA:{m:24,a:5}, CO:{m:49,a:4}, CT:{m:200,a:11}, DE:{m:222,a:9}, FL:{m:995,a:35}, GA:{m:7,a:5}, LA:{m:66,a:2}, MI:{m:44,a:5}, NC:{m:387,a:17}, NJ:{m:3849,a:54}, NY:{m:155,a:20}, OH:{m:3,a:3}, PA:{m:1090,a:19}, RI:{m:20,a:3}, SC:{m:13,a:4}, TN:{m:15,a:5}, TX:{m:636,a:16}, VA:{m:401,a:13}},
  ...
  "Concep Care": {
    total:5158, uniqueAgents:23,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "LA", "ME", "MI", "NC", "NJ", "NV", "OH", "PA", "RI", "SC", "TN", "TX", "VA", "WI"],
    bobState:{AL:{m:19,a:2}, AZ:{m:11,a:3}, CA:{m:24,a:2}, CO:{m:146,a:11}, CT:{m:152,a:5}, DE:{m:20,a:2}, FL:{m:1690,a:18}, GA:{m:51,a:3}, LA:{m:1,a:1}, ME:{m:1,a:1}, MI:{m:26,a:3}, NC:{m:450,a:8}, NJ:{m:927,a:19}, NV:{m:2,a:1}, OH:{m:193,a:5}, PA:{m:237,a:14}, RI:{m:296,a:4}, SC:{m:13,a:2}, TN:{m:25,a:4}, TX:{m:815,a:15}, VA:{m:56,a:6}, WI:{m:3,a:1}},
  ...
  "GW Ins Group": {
    ...
    bobState:{AZ:{m:85,a:3}, CT:{m:79,a:3}, DE:{m:8,a:2}, FL:{m:542,a:9}, NC:{m:27,a:2}, NJ:{m:593,a:10}, NY:{m:27,a:4}, OH:{m:88,a:4}, PA:{m:97,a:6}, PR:{m:2,a:1}, RI:{m:3,a:1}, SC:{m:14,a:1}, TX:{m:136,a:6}, VA:{m:21,a:2}},
  ...
  "Simarova Senior": {
    total:1527, uniqueAgents:10,
    states:["AZ", "CO", "CT", "FL", "GA", "LA", "MI", "NC", "NJ", "OH", "PA", "RI", "TX", "VA", "WI"],
    bobState:{AZ:{m:2,a:1}, CO:{m:185,a:6}, CT:{m:18,a:2}, FL:{m:396,a:7}, GA:{m:1,a:1}, LA:{m:6,a:1}, MI:{m:8,a:2}, NC:{m:144,a:5}, NJ:{m:18,a:5}, OH:{m:60,a:4}, PA:{m:90,a:5}, RI:{m:98,a:5}, TX:{m:496,a:8}, VA:{m:2,a:2}, WI:{m:3,a:1}},
  ...
  "KMRA Group": {
    total:1203, uniqueAgents:11,
    states:["AZ", "DE", "FL", "NJ", "PA", "SC", "TX"],
    bobState:{AZ:{m:1,a:1}, DE:{m:1,a:1}, FL:{m:8,a:4}, NJ:{m:471,a:8}, PA:{m:697,a:8}, SC:{m:1,a:1}, TX:{m:24,a:1}},
  ...
  "Martell Multi": {
    total:1050, uniqueAgents:10,
    states:["DE", "NJ", "NY", "PA", "TX"],
    bobState:{DE:{m:1,a:1}, NJ:{m:502,a:10}, NY:{m:1,a:1}, PA:{m:391,a:3}, TX:{m:155,a:2}},
  ...
  "TCS & Associates": {
    total:866, uniqueAgents:14,
    states:["FL", "LA", "NC", "NJ", "TX"],
    bobState:{FL:{m:303,a:6}, LA:{m:11,a:2}, NC:{m:33,a:3}, NJ:{m:23,a:6}, TX:{m:496,a:12}},
  ...
  "AMC Care Group": {
    total:702, uniqueAgents:4,
    states:["CA", "CO", "CT", "FL", "LA", "MI", "NC", "NJ", "NY", "OH", "PA", "SC", "TX"],
    bobState:{CA:{m:2,a:2}, CO:{m:33,a:1}, CT:{m:26,a:1}, FL:{m:4,a:1}, LA:{m:9,a:1}, MI:{m:21,a:1}, NC:{m:206,a:4}, NJ:{m:5,a:3}, NY:{m:15,a:2}, OH:{m:10,a:1}, PA:{m:38,a:2}, SC:{m:8,a:1}, TX:{m:325,a:4}},
  ...
  "Top Tier Health": {
    total:382, uniqueAgents:6,
    states:["CT", "DE", "FL", "NJ", "NY", "VA"],
    bobState:{CT:{m:2,a:1}, DE:{m:12,a:2}, FL:{m:6,a:3}, NJ:{m:174,a:5}, NY:{m:187,a:6}, VA:{m:1,a:1}},
    aps:{DE:2, NJ:5, NY:6},
  ...
  "JPM Solutions": {
    total:250, uniqueAgents:5,
    states:["AL", "DE", "FL", "NJ", "NY", "PA", "TX"],
    bobState:{AL:{m:12,a:2}, DE:{m:2,a:1}, FL:{m:14,a:3}, NJ:{m:124,a:4}, NY:{m:9,a:1}, PA:{m:58,a:1}, TX:{m:31,a:2}},
...
function BobBadge(){
  return(
    <div style={{display:"inline-flex",alignItems:"center",gap:5,background:"#1a0f2e",border:"1px solid #8b5cf655",borderRadius:6,padding:"4px 10px",fontSize:10,color:"#c4b5fd"}}>
      📊 <strong style={{color:"#a78bfa"}}>BOB REAL</strong>  ·  21,181 policies  ·  776 counties  ·  4,275 zips  ·  09-09-2026
    </div>
  );
}
      ...
      {open && (
        <div style={{position:"absolute",top:"calc(100% + 6px)",left:0,background:"#0c1222",border:"1px solid "+UHC_GOLD+"66",borderRadius:10,padding:8,minWidth:280,boxShadow:"0 24px 50px #00000099",zIndex:200}}>
          ...
          >
            ...
            <span style={{marginLeft:"auto",color:"#334155",fontSize:11}}>21,181 policies</span>
          </div>
          {agencies.map(a => (
            <div
              key={a.short}
        ...
        <div style={{background:"linear-gradient(135deg,#001a5e,#002677)",padding:"13px 15px",borderBottom:"2px solid "+mc}}>
          ...
          <div style={{marginTop:10,display:"inline-flex",alignItems:"center",gap:8,background:mc+"22",borderRadius:8,padding:"6px 12px",border:"1px solid "+mc+"44"}}>
            ...
            <div>
              ...
              <div style={{color:"#93c5fd",fontSize:10}}>{mode==="eligible"?"Source: CMS API 2024":"Source: ACM BOB 09-09-2026"}</div>
            </div>
          </div>
        </div>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
          <div style={{display:"flex",alignItems:"center",gap:18}}>
            ...
            <div>
              ...
              <p style={{margin:"3px 0 0",color:"#93c5fd",fontSize:11}}>State Director Presentation  ·  Medicare Advantage  ·  BOB as of 09-09-2026</p>
            </div>
          </div>
      ...
      <div style={{padding:"18px 24px"}}>
        ...
        {tab==="zip"&&(
          <div style={{background:"#0f172a",borderRadius:12,padding:18,border:"1px solid #1e293b"}}>
            ...
            <p style={{color:"#475569",fontSize:12,marginBottom:12}}>Top 20 zip codes per state  ·  Each zip shows its county  ·  Source: ACM_BOB_09-09-2026.xlsx</p>
        ...
        <div style={{marginTop:22,padding:"12px 0",borderTop:"1px solid #0f172a",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:6}}>
          <div style={{display:"flex",flexDirection:"column",gap:3}}>
            <span style={{color:"#94a3b8",fontSize:10}}>📊 BOB: ACM_BOB_09-09-26.xlsx  ·  21,181 active policies  ·  776 counties  ·  134 agents  ·  22 states</span>
