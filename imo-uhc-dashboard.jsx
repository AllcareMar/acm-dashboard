...
// ── STATE-LEVEL BOB ──
const BOB={AL:{m:132,a:6}, AZ:{m:150,a:10}, CA:{m:52,a:8}, CO:{m:420,a:20}, CT:{m:452,a:18}, DE:{m:276,a:16}, FL:{m:4114,a:78}, GA:{m:59,a:7}, LA:{m:98,a:5}, MA:{m:2,a:2}, MI:{m:108,a:10}, NC:{m:1298,a:29}, NJ:{m:6574,a:101}, NM:{m:1,a:1}, NY:{m:400,a:30}, OH:{m:381,a:15}, PA:{m:2740,a:52}, RI:{m:414,a:12}, SC:{m:48,a:7}, TN:{m:42,a:10}, TX:{m:3258,a:60}, VA:{m:497,a:17}, WI:{m:6,a:2}};
...
const AGENCY_DATA = {
  "AllCare Mar": {
    total:8367, uniqueAgents:69,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "LA", "MI", "NC", "NJ", "NM", "NY", "OH", "PA", "RI", "SC", "TN", "TX", "VA"],
    bobState:{AL:{m:98,a:3}, AZ:{m:44,a:3}, CA:{m:26,a:5}, CO:{m:50,a:4}, CT:{m:174,a:9}, DE:{m:231,a:9}, FL:{m:1036,a:34}, GA:{m:6,a:4}, LA:{m:70,a:2}, MI:{m:48,a:4}, NC:{m:394,a:15}, NJ:{m:3806,a:51}, NM:{m:1,a:1}, NY:{m:163,a:20}, OH:{m:1,a:1}, PA:{m:1123,a:16}, RI:{m:18,a:3}, SC:{m:11,a:4}, TN:{m:16,a:5}, TX:{m:636,a:15}, VA:{m:415,a:10}},
  ...
  "Concep Care": {
    total:5406, uniqueAgents:25,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "MA", "MI", "NC", "NJ", "OH", "PA", "RI", "SC", "TN", "TX", "VA", "WI"],
    bobState:{AL:{m:22,a:2}, AZ:{m:12,a:3}, CA:{m:24,a:2}, CO:{m:146,a:9}, CT:{m:157,a:5}, DE:{m:20,a:2}, FL:{m:1785,a:21}, GA:{m:53,a:3}, MA:{m:1,a:1}, MI:{m:29,a:3}, NC:{m:484,a:8}, NJ:{m:964,a:20}, OH:{m:206,a:5}, PA:{m:246,a:13}, RI:{m:296,a:4}, SC:{m:16,a:2}, TN:{m:26,a:5}, TX:{m:859,a:15}, VA:{m:57,a:6}, WI:{m:3,a:1}},
  ...
  "GW Ins Group": {
    total:1673, uniqueAgents:13,
    states:["AZ", "CT", "DE", "FL", "NC", "NJ", "NY", "OH", "PA", "SC", "TX", "VA"],
    bobState:{AZ:{m:92,a:3}, CT:{m:71,a:3}, DE:{m:9,a:2}, FL:{m:528,a:9}, NC:{m:24,a:2}, NJ:{m:561,a:9}, NY:{m:22,a:4}, OH:{m:95,a:4}, PA:{m:103,a:6}, SC:{m:11,a:1}, TX:{m:134,a:6}, VA:{m:23,a:3}},
  ...
  "Simarova Senior": {
    total:1600, uniqueAgents:10,
    states:["AZ", "CO", "CT", "FL", "LA", "MI", "NC", "NJ", "OH", "PA", "RI", "TX", "VA", "WI"],
    bobState:{AZ:{m:2,a:1}, CO:{m:189,a:6}, CT:{m:19,a:2}, FL:{m:418,a:7}, LA:{m:6,a:1}, MI:{m:9,a:2}, NC:{m:151,a:5}, NJ:{m:14,a:5}, OH:{m:68,a:4}, PA:{m:96,a:5}, RI:{m:100,a:5}, TX:{m:523,a:8}, VA:{m:2,a:2}, WI:{m:3,a:1}},
  ...
  "KMRA Group": {
    total:1162, uniqueAgents:11,
    states:["DE", "FL", "NJ", "PA", "TX"],
    bobState:{DE:{m:1,a:1}, FL:{m:9,a:4}, NJ:{m:454,a:8}, PA:{m:672,a:8}, TX:{m:26,a:1}},
  ...
  "Martell Multi": {
    ...
    states:["NJ", "NY", "PA", "TX"],
    bobState:{NJ:{m:476,a:10}, NY:{m:1,a:1}, PA:{m:398,a:3}, TX:{m:160,a:2}},
  ...
  "TCS & Associates": {
    ...
    states:["FL", "LA", "MA", "NC", "NJ", "TX"],
    bobState:{FL:{m:320,a:6}, LA:{m:13,a:2}, MA:{m:1,a:1}, NC:{m:34,a:2}, NJ:{m:31,a:6}, TX:{m:550,a:12}},
  ...
  "AMC Care Group": {
    total:736, uniqueAgents:4,
    states:["CA", "CO", "CT", "FL", "LA", "MI", "NC", "NJ", "NY", "OH", "PA", "SC", "TX"],
    bobState:{CA:{m:2,a:2}, CO:{m:35,a:1}, CT:{m:31,a:1}, FL:{m:4,a:1}, LA:{m:9,a:1}, MI:{m:22,a:1}, NC:{m:211,a:2}, NJ:{m:6,a:3}, NY:{m:16,a:2}, OH:{m:11,a:1}, PA:{m:41,a:2}, SC:{m:10,a:1}, TX:{m:338,a:4}},
  ...
  "Top Tier Health": {
    total:360, uniqueAgents:6,
    states:["DE", "FL", "NJ", "NY"],
    bobState:{DE:{m:13,a:2}, FL:{m:1,a:1}, NJ:{m:158,a:5}, NY:{m:188,a:6}},
    aps:{DE:2, NJ:5, NY:6},
  ...
  "JPM Solutions": {
    total:220, uniqueAgents:4,
    states:["AL", "DE", "FL", "NJ", "NY", "PA", "TX"],
    bobState:{AL:{m:12,a:2}, DE:{m:2,a:1}, FL:{m:13,a:2}, NJ:{m:91,a:3}, NY:{m:10,a:1}, PA:{m:60,a:1}, TX:{m:32,a:2}},
...
function BobBadge(){
  return(
    <div style={{display:"inline-flex",alignItems:"center",gap:5,background:"#1a0f2e",border:"1px solid #8b5cf655",borderRadius:6,padding:"4px 10px",fontSize:10,color:"#c4b5fd"}}>
      📊 <strong style={{color:"#a78bfa"}}>BOB REAL</strong>  ·  21,522 policies  ·  776 counties  ·  4,275 zips  ·  05-19-2026
    </div>
  );
}
      ...
      {open && (
        <div style={{position:"absolute",top:"calc(100% + 6px)",left:0,background:"#0c1222",border:"1px solid "+UHC_GOLD+"66",borderRadius:10,padding:8,minWidth:280,boxShadow:"0 24px 50px #00000099",zIndex:200}}>
          ...
          >
            ...
            <span style={{marginLeft:"auto",color:"#334155",fontSize:11}}>21,522 policies</span>
          </div>
          {agencies.map(a => (
            <div
              key={a.short}
        ...
        <div style={{background:"linear-gradient(135deg,#001a5e,#002677)",padding:"13px 15px",borderBottom:"2px solid "+mc}}>
          ...
          <div style={{marginTop:10,display:"inline-flex",alignItems:"center",gap:8,background:mc+"22",borderRadius:8,padding:"6px 12px",border:"1px solid "+mc+"44"}}>
            ...
            <div>
              ...
              <div style={{color:"#93c5fd",fontSize:10}}>{mode==="eligible"?"Source: CMS API 2024":"Source: ACM BOB 05-19-2026"}</div>
            </div>
          </div>
        </div>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
          <div style={{display:"flex",alignItems:"center",gap:18}}>
            ...
            <div>
              ...
              <p style={{margin:"3px 0 0",color:"#93c5fd",fontSize:11}}>State Director Presentation  ·  Medicare Advantage  ·  BOB as of 05-19-2026</p>
            </div>
          </div>
      ...
      <div style={{padding:"18px 24px"}}>
        ...
        {tab==="zip"&&(
          <div style={{background:"#0f172a",borderRadius:12,padding:18,border:"1px solid #1e293b"}}>
            ...
            <p style={{color:"#475569",fontSize:12,marginBottom:12}}>Top 20 zip codes per state  ·  Each zip shows its county  ·  Source: ACM_BOB_05-19-2026.xlsx</p>
        ...
        <div style={{marginTop:22,padding:"12px 0",borderTop:"1px solid #0f172a",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:6}}>
          <div style={{display:"flex",flexDirection:"column",gap:3}}>
            <span style={{color:"#94a3b8",fontSize:10}}>📊 BOB: ACM_BOB_05-19-26.xlsx  ·  21,522 active policies  ·  776 counties  ·  134 agents  ·  22 states</span>
