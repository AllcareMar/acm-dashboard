...
// ── STATE-LEVEL BOB ──
const BOB={AL:{m:128,a:6}, AZ:{m:136,a:10}, CA:{m:52,a:8}, CO:{m:419,a:22}, CT:{m:444,a:18}, DE:{m:269,a:16}, FL:{m:4054,a:77}, GA:{m:59,a:7}, LA:{m:96,a:5}, MI:{m:104,a:11}, NC:{m:1279,a:30}, NJ:{m:6605,a:101}, NY:{m:400,a:29}, OH:{m:366,a:15}, PA:{m:2721,a:56}, PR:{m:2,a:1}, RI:{m:415,a:12}, SC:{m:48,a:7}, TN:{m:41,a:9}, TX:{m:3205,a:59}, VA:{m:485,a:18}, WI:{m:6,a:2}};
...
const AGENCY_DATA = {
  "AllCare Mar": {
    total:8284, uniqueAgents:71,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "LA", "MI", "NC", "NJ", "NY", "OH", "PA", "RI", "SC", "TN", "TX", "VA"],
    bobState:{AL:{m:96,a:3}, AZ:{m:35,a:3}, CA:{m:26,a:5}, CO:{m:44,a:4}, CT:{m:169,a:9}, DE:{m:226,a:9}, FL:{m:1017,a:34}, GA:{m:6,a:4}, LA:{m:69,a:2}, MI:{m:47,a:5}, NC:{m:387,a:15}, NJ:{m:3807,a:53}, NY:{m:162,a:19}, OH:{m:1,a:1}, PA:{m:1114,a:20}, RI:{m:20,a:3}, SC:{m:12,a:4}, TN:{m:16,a:5}, TX:{m:628,a:15}, VA:{m:402,a:11}},
  ...
  "Concep Care": {
    total:5305, uniqueAgents:24,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "MI", "NC", "NJ", "OH", "PA", "RI", "SC", "TN", "TX", "VA", "WI"],
    bobState:{AL:{m:20,a:2}, AZ:{m:12,a:3}, CA:{m:24,a:2}, CO:{m:152,a:11}, CT:{m:156,a:5}, DE:{m:20,a:2}, FL:{m:1746,a:20}, GA:{m:53,a:3}, MI:{m:28,a:3}, NC:{m:471,a:8}, NJ:{m:940,a:19}, OH:{m:201,a:5}, PA:{m:243,a:14}, RI:{m:297,a:4}, SC:{m:15,a:2}, TN:{m:25,a:4}, TX:{m:841,a:15}, VA:{m:58,a:6}, WI:{m:3,a:1}},
  ...
  "GW Ins Group": {
    total:1698, uniqueAgents:13,
    states:["AZ", "CT", "DE", "FL", "NC", "NJ", "NY", "OH", "PA", "PR", "SC", "TX", "VA"],
    bobState:{AZ:{m:87,a:3}, CT:{m:72,a:3}, DE:{m:8,a:2}, FL:{m:540,a:9}, NC:{m:27,a:2}, NJ:{m:576,a:9}, NY:{m:24,a:4}, OH:{m:91,a:4}, PA:{m:99,a:6}, PR:{m:2,a:1}, SC:{m:12,a:1}, TX:{m:137,a:6}, VA:{m:23,a:3}},
  ...
  "Simarova Senior": {
    ...
    bobState:{AZ:{m:2,a:1}, CO:{m:189,a:6}, CT:{m:18,a:2}, FL:{m:412,a:7}, LA:{m:6,a:1}, MI:{m:8,a:2}, NC:{m:148,a:5}, NJ:{m:17,a:5}, OH:{m:63,a:4}, PA:{m:92,a:5}, RI:{m:98,a:5}, TX:{m:511,a:8}, VA:{m:2,a:2}, WI:{m:3,a:1}},
  ...
  "KMRA Group": {
    total:1171, uniqueAgents:11,
    states:["DE", "FL", "NJ", "PA", "TX"],
    bobState:{DE:{m:1,a:1}, FL:{m:9,a:4}, NJ:{m:453,a:8}, PA:{m:682,a:8}, TX:{m:26,a:1}},
  ...
  "Martell Multi": {
    total:1037, uniqueAgents:10,
    states:["NJ", "NY", "PA", "TX"],
    bobState:{NJ:{m:487,a:10}, NY:{m:1,a:1}, PA:{m:391,a:3}, TX:{m:158,a:2}},
  ...
  "Top Tier Health": {
    ...
    states:["DE", "FL", "NJ", "NY"],
    bobState:{DE:{m:12,a:2}, FL:{m:2,a:2}, NJ:{m:161,a:5}, NY:{m:188,a:6}},
    aps:{DE:2, NJ:5, NY:6},
...
function BobBadge(){
  return(
    <div style={{display:"inline-flex",alignItems:"center",gap:5,background:"#1a0f2e",border:"1px solid #8b5cf655",borderRadius:6,padding:"4px 10px",fontSize:10,color:"#c4b5fd"}}>
      📊 <strong style={{color:"#a78bfa"}}>BOB REAL</strong>  ·  21,334 policies  ·  776 counties  ·  4,275 zips  ·  07-07-2026
    </div>
  );
}
      ...
      {open && (
        <div style={{position:"absolute",top:"calc(100% + 6px)",left:0,background:"#0c1222",border:"1px solid "+UHC_GOLD+"66",borderRadius:10,padding:8,minWidth:280,boxShadow:"0 24px 50px #00000099",zIndex:200}}>
          ...
          >
            ...
            <span style={{marginLeft:"auto",color:"#334155",fontSize:11}}>21,334 policies</span>
          </div>
          {agencies.map(a => (
            <div
              key={a.short}
        ...
        <div style={{background:"linear-gradient(135deg,#001a5e,#002677)",padding:"13px 15px",borderBottom:"2px solid "+mc}}>
          ...
          <div style={{marginTop:10,display:"inline-flex",alignItems:"center",gap:8,background:mc+"22",borderRadius:8,padding:"6px 12px",border:"1px solid "+mc+"44"}}>
            ...
            <div>
              ...
              <div style={{color:"#93c5fd",fontSize:10}}>{mode==="eligible"?"Source: CMS API 2024":"Source: ACM BOB 07-07-2026"}</div>
            </div>
          </div>
        </div>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
          <div style={{display:"flex",alignItems:"center",gap:18}}>
            ...
            <div>
              ...
              <p style={{margin:"3px 0 0",color:"#93c5fd",fontSize:11}}>State Director Presentation  ·  Medicare Advantage  ·  BOB as of 07-07-2026</p>
            </div>
          </div>
      ...
      <div style={{padding:"18px 24px"}}>
        ...
        {tab==="zip"&&(
          <div style={{background:"#0f172a",borderRadius:12,padding:18,border:"1px solid #1e293b"}}>
            ...
            <p style={{color:"#475569",fontSize:12,marginBottom:12}}>Top 20 zip codes per state  ·  Each zip shows its county  ·  Source: ACM_BOB_07-07-2026.xlsx</p>
        ...
        <div style={{marginTop:22,padding:"12px 0",borderTop:"1px solid #0f172a",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:6}}>
          <div style={{display:"flex",flexDirection:"column",gap:3}}>
            <span style={{color:"#94a3b8",fontSize:10}}>📊 BOB: ACM_BOB_07-07-26.xlsx  ·  21,334 active policies  ·  776 counties  ·  134 agents  ·  22 states</span>
