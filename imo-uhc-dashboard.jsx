...
// ── STATE-LEVEL BOB ──
const BOB={AL:{m:128,a:6}, AZ:{m:132,a:12}, CA:{m:51,a:8}, CO:{m:406,a:22}, CT:{m:477,a:20}, DE:{m:267,a:17}, FL:{m:3967,a:75}, GA:{m:59,a:9}, LA:{m:95,a:6}, ME:{m:1,a:1}, MI:{m:101,a:11}, NC:{m:1245,a:32}, NJ:{m:6700,a:103}, NV:{m:1,a:1}, NY:{m:394,a:30}, OH:{m:358,a:17}, PA:{m:2706,a:55}, PR:{m:2,a:1}, RI:{m:416,a:13}, SC:{m:49,a:8}, TN:{m:40,a:9}, TX:{m:3145,a:60}, VA:{m:481,a:22}, WI:{m:6,a:2}};
...
const AGENCY_DATA = {
  "AllCare Mar": {
    total:8322, uniqueAgents:69,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "LA", "MI", "NC", "NJ", "NY", "OH", "PA", "RI", "SC", "TN", "TX", "VA"],
    bobState:{AL:{m:97,a:3}, AZ:{m:34,a:4}, CA:{m:25,a:5}, CO:{m:42,a:4}, CT:{m:198,a:11}, DE:{m:223,a:9}, FL:{m:993,a:34}, GA:{m:6,a:4}, LA:{m:67,a:2}, MI:{m:45,a:5}, NC:{m:387,a:15}, NJ:{m:3864,a:54}, NY:{m:157,a:20}, OH:{m:4,a:4}, PA:{m:1094,a:19}, RI:{m:20,a:3}, SC:{m:12,a:4}, TN:{m:15,a:5}, TX:{m:638,a:17}, VA:{m:400,a:13}},
  ...
  "Concep Care": {
    total:5190, uniqueAgents:24,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "LA", "ME", "MI", "NC", "NJ", "NV", "OH", "PA", "RI", "SC", "TN", "TX", "VA", "WI"],
    bobState:{AL:{m:19,a:2}, AZ:{m:11,a:3}, CA:{m:24,a:2}, CO:{m:145,a:11}, CT:{m:152,a:5}, DE:{m:20,a:2}, FL:{m:1703,a:19}, GA:{m:52,a:4}, LA:{m:1,a:1}, ME:{m:1,a:1}, MI:{m:27,a:3}, NC:{m:451,a:8}, NJ:{m:933,a:19}, NV:{m:1,a:1}, OH:{m:196,a:5}, PA:{m:239,a:14}, RI:{m:295,a:4}, SC:{m:13,a:2}, TN:{m:25,a:4}, TX:{m:820,a:15}, VA:{m:56,a:6}, WI:{m:3,a:1}},
  ...
  "GW Ins Group": {
    total:1718, uniqueAgents:14,
    states:["AZ", "CT", "DE", "FL", "NC", "NJ", "NY", "OH", "PA", "PR", "RI", "SC", "TX", "VA"],
    bobState:{AZ:{m:84,a:3}, CT:{m:78,a:3}, DE:{m:8,a:2}, FL:{m:538,a:9}, NC:{m:27,a:2}, NJ:{m:593,a:10}, NY:{m:27,a:4}, OH:{m:88,a:4}, PA:{m:98,a:6}, PR:{m:2,a:1}, RI:{m:3,a:1}, SC:{m:14,a:1}, TX:{m:136,a:6}, VA:{m:21,a:2}},
  ...
  "Simarova Senior": {
    total:1534, uniqueAgents:10,
    states:["AZ", "CO", "CT", "FL", "GA", "LA", "MI", "NC", "NJ", "OH", "PA", "RI", "TX", "VA", "WI"],
    bobState:{AZ:{m:2,a:1}, CO:{m:185,a:6}, CT:{m:18,a:2}, FL:{m:397,a:7}, GA:{m:1,a:1}, LA:{m:6,a:1}, MI:{m:8,a:2}, NC:{m:144,a:5}, NJ:{m:18,a:5}, OH:{m:60,a:4}, PA:{m:91,a:5}, RI:{m:98,a:5}, TX:{m:499,a:8}, VA:{m:2,a:2}, WI:{m:3,a:1}},
  ...
  "KMRA Group": {
    total:1199, uniqueAgents:11,
    states:["AZ", "DE", "FL", "NJ", "PA", "SC", "TX"],
    bobState:{AZ:{m:1,a:1}, DE:{m:1,a:1}, FL:{m:9,a:4}, NJ:{m:467,a:8}, PA:{m:695,a:8}, SC:{m:1,a:1}, TX:{m:25,a:1}},
  ...
  "Martell Multi": {
    total:1043, uniqueAgents:10,
    states:["DE", "NJ", "NY", "PA", "TX", "VA"],
    bobState:{DE:{m:1,a:1}, NJ:{m:492,a:10}, NY:{m:1,a:1}, PA:{m:392,a:3}, TX:{m:155,a:2}, VA:{m:1,a:1}},
  ...
  "TCS & Associates": {
    total:884, uniqueAgents:14,
    states:["FL", "LA", "NC", "NJ", "TX"],
    bobState:{FL:{m:303,a:6}, LA:{m:12,a:2}, NC:{m:33,a:2}, NJ:{m:24,a:6}, TX:{m:512,a:12}},
  ...
  "AMC Care Group": {
    ...
    bobState:{CA:{m:2,a:2}, CO:{m:34,a:1}, CT:{m:29,a:1}, FL:{m:4,a:1}, LA:{m:9,a:1}, MI:{m:21,a:1}, NC:{m:203,a:4}, NJ:{m:5,a:3}, NY:{m:15,a:2}, OH:{m:10,a:1}, PA:{m:38,a:2}, SC:{m:9,a:1}, TX:{m:329,a:4}},
  ...
  "Top Tier Health": {
    total:378, uniqueAgents:6,
    states:["CT", "DE", "FL", "NJ", "NY", "VA"],
    bobState:{CT:{m:2,a:1}, DE:{m:12,a:2}, FL:{m:7,a:3}, NJ:{m:170,a:5}, NY:{m:186,a:6}, VA:{m:1,a:1}},
    aps:{DE:2, NJ:5, NY:6},
  ...
  "JPM Solutions": {
    total:244, uniqueAgents:5,
    states:["AL", "DE", "FL", "NJ", "NY", "PA", "TX"],
    bobState:{AL:{m:12,a:2}, DE:{m:2,a:1}, FL:{m:13,a:3}, NJ:{m:120,a:4}, NY:{m:8,a:1}, PA:{m:58,a:1}, TX:{m:31,a:2}},
...
function BobBadge(){
  return(
    <div style={{display:"inline-flex",alignItems:"center",gap:5,background:"#1a0f2e",border:"1px solid #8b5cf655",borderRadius:6,padding:"4px 10px",fontSize:10,color:"#c4b5fd"}}>
      📊 <strong style={{color:"#a78bfa"}}>BOB REAL</strong>  ·  21,235 policies  ·  776 counties  ·  4,275 zips  ·  09-01-2026
    </div>
  );
}
      ...
      {open && (
        <div style={{position:"absolute",top:"calc(100% + 6px)",left:0,background:"#0c1222",border:"1px solid "+UHC_GOLD+"66",borderRadius:10,padding:8,minWidth:280,boxShadow:"0 24px 50px #00000099",zIndex:200}}>
          ...
          >
            ...
            <span style={{marginLeft:"auto",color:"#334155",fontSize:11}}>21,235 policies</span>
          </div>
          {agencies.map(a => (
            <div
              key={a.short}
        ...
        <div style={{background:"linear-gradient(135deg,#001a5e,#002677)",padding:"13px 15px",borderBottom:"2px solid "+mc}}>
          ...
          <div style={{marginTop:10,display:"inline-flex",alignItems:"center",gap:8,background:mc+"22",borderRadius:8,padding:"6px 12px",border:"1px solid "+mc+"44"}}>
            ...
            <div>
              ...
              <div style={{color:"#93c5fd",fontSize:10}}>{mode==="eligible"?"Source: CMS API 2024":"Source: ACM BOB 09-01-2026"}</div>
            </div>
          </div>
        </div>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
          <div style={{display:"flex",alignItems:"center",gap:18}}>
            ...
            <div>
              ...
              <p style={{margin:"3px 0 0",color:"#93c5fd",fontSize:11}}>State Director Presentation  ·  Medicare Advantage  ·  BOB as of 09-01-2026</p>
            </div>
          </div>
      ...
      <div style={{padding:"18px 24px"}}>
        ...
        {tab==="zip"&&(
          <div style={{background:"#0f172a",borderRadius:12,padding:18,border:"1px solid #1e293b"}}>
            ...
            <p style={{color:"#475569",fontSize:12,marginBottom:12}}>Top 20 zip codes per state  ·  Each zip shows its county  ·  Source: ACM_BOB_09-01-2026.xlsx</p>
        ...
        <div style={{marginTop:22,padding:"12px 0",borderTop:"1px solid #0f172a",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:6}}>
          <div style={{display:"flex",flexDirection:"column",gap:3}}>
            <span style={{color:"#94a3b8",fontSize:10}}>📊 BOB: ACM_BOB_09-01-26.xlsx  ·  21,235 active policies  ·  776 counties  ·  134 agents  ·  22 states</span>
