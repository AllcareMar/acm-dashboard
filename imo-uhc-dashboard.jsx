...
// ── STATE-LEVEL BOB ──
const BOB={AL:{m:128,a:6}, AZ:{m:136,a:11}, CA:{m:51,a:8}, CO:{m:418,a:22}, CT:{m:477,a:20}, DE:{m:269,a:16}, FL:{m:4048,a:77}, GA:{m:58,a:8}, LA:{m:96,a:5}, MI:{m:104,a:11}, NC:{m:1275,a:31}, NJ:{m:6709,a:102}, NY:{m:401,a:29}, OH:{m:366,a:15}, OK:{m:1,a:1}, PA:{m:2724,a:57}, PR:{m:2,a:1}, RI:{m:419,a:13}, SC:{m:51,a:8}, TN:{m:41,a:9}, TX:{m:3224,a:60}, VA:{m:490,a:20}, WI:{m:6,a:2}};
...
const AGENCY_DATA = {
  "AllCare Mar": {
    total:8398, uniqueAgents:71,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "LA", "MI", "NC", "NJ", "NY", "OH", "PA", "RI", "SC", "TN", "TX", "VA"],
    bobState:{AL:{m:96,a:3}, AZ:{m:34,a:3}, CA:{m:26,a:5}, CO:{m:44,a:4}, CT:{m:200,a:11}, DE:{m:226,a:9}, FL:{m:1016,a:35}, GA:{m:5,a:3}, LA:{m:69,a:2}, MI:{m:47,a:5}, NC:{m:382,a:15}, NJ:{m:3855,a:54}, NY:{m:160,a:19}, OH:{m:2,a:2}, PA:{m:1112,a:20}, RI:{m:21,a:3}, SC:{m:12,a:4}, TN:{m:16,a:5}, TX:{m:641,a:16}, VA:{m:406,a:12}},
  ...
  "Concep Care": {
    total:5295, uniqueAgents:25,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "MI", "NC", "NJ", "OH", "PA", "RI", "SC", "TN", "TX", "VA", "WI"],
    bobState:{AL:{m:20,a:2}, AZ:{m:12,a:3}, CA:{m:23,a:2}, CO:{m:152,a:11}, CT:{m:155,a:5}, DE:{m:20,a:2}, FL:{m:1742,a:20}, GA:{m:51,a:3}, MI:{m:28,a:3}, NC:{m:467,a:8}, NJ:{m:944,a:19}, OH:{m:200,a:5}, PA:{m:241,a:14}, RI:{m:297,a:4}, SC:{m:15,a:2}, TN:{m:25,a:4}, TX:{m:838,a:15}, VA:{m:58,a:6}, WI:{m:3,a:1}},
  ...
  "GW Ins Group": {
    total:1736, uniqueAgents:14,
    states:["AZ", "CT", "DE", "FL", "NC", "NJ", "NY", "OH", "OK", "PA", "PR", "RI", "SC", "TX", "VA"],
    bobState:{AZ:{m:87,a:3}, CT:{m:73,a:3}, DE:{m:8,a:2}, FL:{m:541,a:9}, NC:{m:27,a:2}, NJ:{m:590,a:10}, NY:{m:27,a:4}, OH:{m:91,a:4}, OK:{m:1,a:1}, PA:{m:100,a:7}, PR:{m:2,a:1}, RI:{m:3,a:1}, SC:{m:14,a:1}, TX:{m:142,a:6}, VA:{m:23,a:3}},
  ...
  "Simarova Senior": {
    total:1565, uniqueAgents:10,
    states:["AZ", "CO", "CT", "FL", "GA", "LA", "MI", "NC", "NJ", "OH", "PA", "RI", "TX", "VA", "WI"],
    bobState:{AZ:{m:2,a:1}, CO:{m:188,a:6}, CT:{m:18,a:2}, FL:{m:408,a:7}, GA:{m:1,a:1}, LA:{m:6,a:1}, MI:{m:8,a:2}, NC:{m:147,a:5}, NJ:{m:19,a:5}, OH:{m:63,a:4}, PA:{m:91,a:5}, RI:{m:98,a:5}, TX:{m:511,a:8}, VA:{m:2,a:2}, WI:{m:3,a:1}},
  ...
  "KMRA Group": {
    ...
    bobState:{AZ:{m:1,a:1}, DE:{m:1,a:1}, FL:{m:9,a:4}, NJ:{m:468,a:8}, PA:{m:690,a:8}, SC:{m:1,a:1}, TX:{m:26,a:1}},
  ...
  "Martell Multi": {
    ...
    states:["NJ", "NY", "PA", "TX"],
    bobState:{NJ:{m:502,a:10}, NY:{m:1,a:1}, PA:{m:391,a:3}, TX:{m:158,a:2}},
  ...
  "TCS & Associates": {
    total:923, uniqueAgents:14,
    states:["FL", "LA", "NC", "NJ", "TX"],
    bobState:{FL:{m:311,a:6}, LA:{m:12,a:2}, NC:{m:32,a:2}, NJ:{m:32,a:6}, TX:{m:536,a:12}},
  ...
  "AMC Care Group": {
    total:742, uniqueAgents:4,
    states:["CA", "CO", "CT", "FL", "GA", "LA", "MI", "NC", "NJ", "NY", "OH", "PA", "SC", "TX"],
    bobState:{CA:{m:2,a:2}, CO:{m:34,a:1}, CT:{m:31,a:1}, FL:{m:4,a:1}, GA:{m:1,a:1}, LA:{m:9,a:1}, MI:{m:21,a:1}, NC:{m:220,a:4}, NJ:{m:6,a:3}, NY:{m:15,a:2}, OH:{m:10,a:1}, PA:{m:40,a:2}, SC:{m:9,a:1}, TX:{m:340,a:4}},
  ...
  "Top Tier Health": {
    total:367, uniqueAgents:6,
    states:["DE", "FL", "NJ", "NY", "VA"],
    bobState:{DE:{m:12,a:2}, FL:{m:2,a:2}, NJ:{m:163,a:5}, NY:{m:188,a:6}, VA:{m:1,a:1}},
    aps:{DE:2, NJ:5, NY:6},
  ...
  "JPM Solutions": {
    total:246, uniqueAgents:4,
    states:["AL", "DE", "FL", "NJ", "NY", "PA", "TX"],
    bobState:{AL:{m:12,a:2}, DE:{m:2,a:1}, FL:{m:15,a:3}, NJ:{m:116,a:3}, NY:{m:10,a:1}, PA:{m:58,a:1}, TX:{m:32,a:2}},
...
function BobBadge(){
  return(
    <div style={{display:"inline-flex",alignItems:"center",gap:5,background:"#1a0f2e",border:"1px solid #8b5cf655",borderRadius:6,padding:"4px 10px",fontSize:10,color:"#c4b5fd"}}>
      📊 <strong style={{color:"#a78bfa"}}>BOB REAL</strong>  ·  21,541 policies  ·  776 counties  ·  4,275 zips  ·  07-28-2026
    </div>
  );
}
      ...
      {open && (
        <div style={{position:"absolute",top:"calc(100% + 6px)",left:0,background:"#0c1222",border:"1px solid "+UHC_GOLD+"66",borderRadius:10,padding:8,minWidth:280,boxShadow:"0 24px 50px #00000099",zIndex:200}}>
          ...
          >
            ...
            <span style={{marginLeft:"auto",color:"#334155",fontSize:11}}>21,541 policies</span>
          </div>
          {agencies.map(a => (
            <div
              key={a.short}
        ...
        <div style={{background:"linear-gradient(135deg,#001a5e,#002677)",padding:"13px 15px",borderBottom:"2px solid "+mc}}>
          ...
          <div style={{marginTop:10,display:"inline-flex",alignItems:"center",gap:8,background:mc+"22",borderRadius:8,padding:"6px 12px",border:"1px solid "+mc+"44"}}>
            ...
            <div>
              ...
              <div style={{color:"#93c5fd",fontSize:10}}>{mode==="eligible"?"Source: CMS API 2024":"Source: ACM BOB 07-28-2026"}</div>
            </div>
          </div>
        </div>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
          <div style={{display:"flex",alignItems:"center",gap:18}}>
            ...
            <div>
              ...
              <p style={{margin:"3px 0 0",color:"#93c5fd",fontSize:11}}>State Director Presentation  ·  Medicare Advantage  ·  BOB as of 07-28-2026</p>
            </div>
          </div>
      ...
      <div style={{padding:"18px 24px"}}>
        ...
        {tab==="zip"&&(
          <div style={{background:"#0f172a",borderRadius:12,padding:18,border:"1px solid #1e293b"}}>
            ...
            <p style={{color:"#475569",fontSize:12,marginBottom:12}}>Top 20 zip codes per state  ·  Each zip shows its county  ·  Source: ACM_BOB_07-28-2026.xlsx</p>
        ...
        <div style={{marginTop:22,padding:"12px 0",borderTop:"1px solid #0f172a",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:6}}>
          <div style={{display:"flex",flexDirection:"column",gap:3}}>
            <span style={{color:"#94a3b8",fontSize:10}}>📊 BOB: ACM_BOB_07-28-26.xlsx  ·  21,541 active policies  ·  776 counties  ·  134 agents  ·  22 states</span>
