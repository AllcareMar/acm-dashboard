...
// ── STATE-LEVEL BOB ──
const BOB={AL:{m:131,a:6}, AZ:{m:149,a:10}, CA:{m:52,a:8}, CO:{m:420,a:20}, CT:{m:446,a:18}, DE:{m:276,a:16}, FL:{m:4104,a:78}, GA:{m:59,a:7}, LA:{m:98,a:5}, MI:{m:108,a:10}, NC:{m:1293,a:29}, NJ:{m:6555,a:100}, NY:{m:398,a:30}, OH:{m:380,a:15}, PA:{m:2737,a:52}, RI:{m:414,a:12}, SC:{m:48,a:7}, TN:{m:41,a:9}, TX:{m:3256,a:59}, VA:{m:497,a:17}, WI:{m:6,a:2}};
...
const AGENCY_DATA = {
  "AllCare Mar": {
    total:8350, uniqueAgents:69,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "LA", "MI", "NC", "NJ", "NY", "OH", "PA", "RI", "SC", "TN", "TX", "VA"],
    bobState:{AL:{m:97,a:3}, AZ:{m:44,a:3}, CA:{m:26,a:5}, CO:{m:50,a:4}, CT:{m:173,a:9}, DE:{m:231,a:9}, FL:{m:1037,a:34}, GA:{m:6,a:4}, LA:{m:70,a:2}, MI:{m:48,a:4}, NC:{m:390,a:15}, NJ:{m:3794,a:51}, NY:{m:163,a:20}, OH:{m:1,a:1}, PA:{m:1123,a:16}, RI:{m:17,a:3}, SC:{m:11,a:4}, TN:{m:16,a:5}, TX:{m:638,a:15}, VA:{m:415,a:10}},
  ...
  "Concep Care": {
    total:5391, uniqueAgents:25,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "MI", "NC", "NJ", "OH", "PA", "RI", "SC", "TN", "TX", "VA", "WI"],
    bobState:{AL:{m:22,a:2}, AZ:{m:12,a:3}, CA:{m:24,a:2}, CO:{m:146,a:9}, CT:{m:155,a:5}, DE:{m:20,a:2}, FL:{m:1782,a:21}, GA:{m:53,a:3}, MI:{m:29,a:3}, NC:{m:484,a:8}, NJ:{m:961,a:19}, OH:{m:205,a:5}, PA:{m:245,a:13}, RI:{m:296,a:4}, SC:{m:16,a:2}, TN:{m:25,a:4}, TX:{m:856,a:14}, VA:{m:57,a:6}, WI:{m:3,a:1}},
  ...
  "GW Ins Group": {
    total:1661, uniqueAgents:13,
    states:["AZ", "CT", "DE", "FL", "NC", "NJ", "NY", "OH", "PA", "SC", "TX", "VA"],
    bobState:{AZ:{m:91,a:3}, CT:{m:68,a:3}, DE:{m:9,a:2}, FL:{m:523,a:9}, NC:{m:23,a:2}, NJ:{m:560,a:9}, NY:{m:21,a:4}, OH:{m:95,a:4}, PA:{m:103,a:6}, SC:{m:11,a:1}, TX:{m:134,a:6}, VA:{m:23,a:3}},
  ...
  "Simarova Senior": {
    ...
    bobState:{AZ:{m:2,a:1}, CO:{m:189,a:6}, CT:{m:19,a:2}, FL:{m:417,a:7}, LA:{m:6,a:1}, MI:{m:9,a:2}, NC:{m:152,a:5}, NJ:{m:14,a:5}, OH:{m:68,a:4}, PA:{m:95,a:5}, RI:{m:101,a:5}, TX:{m:524,a:8}, VA:{m:2,a:2}, WI:{m:3,a:1}},
  ...
  "KMRA Group": {
    total:1158, uniqueAgents:11,
    states:["DE", "FL", "NJ", "PA", "TX"],
    bobState:{DE:{m:1,a:1}, FL:{m:8,a:4}, NJ:{m:452,a:8}, PA:{m:671,a:8}, TX:{m:26,a:1}},
  ...
  "Martell Multi": {
    total:1034, uniqueAgents:10,
    states:["NJ", "NY", "PA", "TX"],
    bobState:{NJ:{m:475,a:10}, NY:{m:1,a:1}, PA:{m:398,a:3}, TX:{m:160,a:2}},
  ...
  "TCS & Associates": {
    total:948, uniqueAgents:14,
    states:["FL", "LA", "NC", "NJ", "TX"],
    bobState:{FL:{m:319,a:6}, LA:{m:13,a:2}, NC:{m:35,a:2}, NJ:{m:31,a:6}, TX:{m:550,a:12}},
  ...
  "AMC Care Group": {
    total:732, uniqueAgents:4,
    states:["CA", "CO", "CT", "FL", "LA", "MI", "NC", "NJ", "NY", "OH", "PA", "SC", "TX"],
    bobState:{CA:{m:2,a:2}, CO:{m:35,a:1}, CT:{m:31,a:1}, FL:{m:4,a:1}, LA:{m:9,a:1}, MI:{m:22,a:1}, NC:{m:209,a:2}, NJ:{m:6,a:3}, NY:{m:16,a:2}, OH:{m:11,a:1}, PA:{m:41,a:2}, SC:{m:10,a:1}, TX:{m:336,a:4}},
  ...
  "Top Tier Health": {
    total:359, uniqueAgents:6,
    states:["DE", "FL", "NJ", "NY"],
    bobState:{DE:{m:13,a:2}, FL:{m:1,a:1}, NJ:{m:158,a:5}, NY:{m:187,a:6}},
    aps:{DE:2, NJ:5, NY:6},
...
function BobBadge(){
  return(
    <div style={{display:"inline-flex",alignItems:"center",gap:5,background:"#1a0f2e",border:"1px solid #8b5cf655",borderRadius:6,padding:"4px 10px",fontSize:10,color:"#c4b5fd"}}>
      📊 <strong style={{color:"#a78bfa"}}>BOB REAL</strong>  ·  21,468 policies  ·  776 counties  ·  4,275 zips  ·  05-15-2026
    </div>
  );
}
      ...
      {open && (
        <div style={{position:"absolute",top:"calc(100% + 6px)",left:0,background:"#0c1222",border:"1px solid "+UHC_GOLD+"66",borderRadius:10,padding:8,minWidth:280,boxShadow:"0 24px 50px #00000099",zIndex:200}}>
          ...
          >
            ...
            <span style={{marginLeft:"auto",color:"#334155",fontSize:11}}>21,468 policies</span>
          </div>
          {agencies.map(a => (
            <div
              key={a.short}
        ...
        <div style={{background:"linear-gradient(135deg,#001a5e,#002677)",padding:"13px 15px",borderBottom:"2px solid "+mc}}>
          ...
          <div style={{marginTop:10,display:"inline-flex",alignItems:"center",gap:8,background:mc+"22",borderRadius:8,padding:"6px 12px",border:"1px solid "+mc+"44"}}>
            ...
            <div>
              ...
              <div style={{color:"#93c5fd",fontSize:10}}>{mode==="eligible"?"Source: CMS API 2024":"Source: ACM BOB 05-15-2026"}</div>
            </div>
          </div>
        </div>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
          <div style={{display:"flex",alignItems:"center",gap:18}}>
            ...
            <div>
              ...
              <p style={{margin:"3px 0 0",color:"#93c5fd",fontSize:11}}>State Director Presentation  ·  Medicare Advantage  ·  BOB as of 05-15-2026</p>
            </div>
          </div>
      ...
      <div style={{padding:"18px 24px"}}>
        ...
        {tab==="zip"&&(
          <div style={{background:"#0f172a",borderRadius:12,padding:18,border:"1px solid #1e293b"}}>
            ...
            <p style={{color:"#475569",fontSize:12,marginBottom:12}}>Top 20 zip codes per state  ·  Each zip shows its county  ·  Source: ACM_BOB_05-15-2026.xlsx</p>
        ...
        <div style={{marginTop:22,padding:"12px 0",borderTop:"1px solid #0f172a",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:6}}>
          <div style={{display:"flex",flexDirection:"column",gap:3}}>
            <span style={{color:"#94a3b8",fontSize:10}}>📊 BOB: ACM_BOB_05-15-26.xlsx  ·  21,468 active policies  ·  776 counties  ·  134 agents  ·  22 states</span>
