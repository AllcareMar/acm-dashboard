...
// ── STATE-LEVEL BOB ──
const BOB={AL:{m:131,a:6}, AZ:{m:147,a:10}, CA:{m:53,a:8}, CO:{m:423,a:22}, CT:{m:451,a:19}, DE:{m:273,a:16}, FL:{m:4088,a:78}, GA:{m:59,a:7}, LA:{m:97,a:5}, MD:{m:1,a:1}, MI:{m:108,a:10}, NC:{m:1289,a:30}, NJ:{m:6639,a:101}, NY:{m:402,a:29}, OH:{m:378,a:15}, PA:{m:2739,a:54}, PR:{m:2,a:1}, RI:{m:416,a:12}, SC:{m:49,a:7}, TN:{m:41,a:9}, TX:{m:3241,a:60}, VA:{m:488,a:17}, WI:{m:6,a:2}};
...
const AGENCY_DATA = {
  "AllCare Mar": {
    total:8389, uniqueAgents:71,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "LA", "MI", "NC", "NJ", "NY", "OH", "PA", "RI", "SC", "TN", "TX", "VA"],
    bobState:{AL:{m:98,a:3}, AZ:{m:43,a:3}, CA:{m:26,a:5}, CO:{m:50,a:4}, CT:{m:172,a:9}, DE:{m:229,a:9}, FL:{m:1028,a:34}, GA:{m:6,a:4}, LA:{m:70,a:2}, MI:{m:48,a:4}, NC:{m:391,a:15}, NJ:{m:3845,a:53}, NY:{m:164,a:19}, OH:{m:1,a:1}, PA:{m:1125,a:19}, RI:{m:18,a:3}, SC:{m:12,a:4}, TN:{m:16,a:5}, TX:{m:641,a:15}, VA:{m:406,a:10}},
  ...
  "Concep Care": {
    total:5364, uniqueAgents:25,
    states:["AL", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "MI", "NC", "NJ", "OH", "PA", "RI", "SC", "TN", "TX", "VA", "WI"],
    bobState:{AL:{m:21,a:2}, AZ:{m:12,a:3}, CA:{m:25,a:2}, CO:{m:149,a:11}, CT:{m:157,a:5}, DE:{m:20,a:2}, FL:{m:1762,a:21}, GA:{m:53,a:3}, MI:{m:29,a:3}, NC:{m:477,a:8}, NJ:{m:955,a:19}, OH:{m:206,a:5}, PA:{m:246,a:13}, RI:{m:299,a:4}, SC:{m:16,a:2}, TN:{m:25,a:4}, TX:{m:852,a:15}, VA:{m:57,a:6}, WI:{m:3,a:1}},
  ...
  "GW Ins Group": {
    total:1693, uniqueAgents:13,
    states:["AZ", "CT", "DE", "FL", "NC", "NJ", "NY", "OH", "PA", "PR", "SC", "TX", "VA"],
    bobState:{AZ:{m:90,a:3}, CT:{m:73,a:3}, DE:{m:8,a:2}, FL:{m:537,a:9}, NC:{m:25,a:2}, NJ:{m:571,a:9}, NY:{m:24,a:4}, OH:{m:95,a:4}, PA:{m:100,a:6}, PR:{m:2,a:1}, SC:{m:11,a:1}, TX:{m:134,a:6}, VA:{m:23,a:2}},
  ...
  "Simarova Senior": {
    total:1593, uniqueAgents:10,
    states:["AZ", "CO", "CT", "FL", "LA", "MD", "MI", "NC", "NJ", "OH", "PA", "RI", "TX", "VA", "WI"],
    bobState:{AZ:{m:2,a:1}, CO:{m:190,a:6}, CT:{m:19,a:3}, FL:{m:417,a:7}, LA:{m:6,a:1}, MD:{m:1,a:1}, MI:{m:9,a:2}, NC:{m:150,a:5}, NJ:{m:16,a:5}, OH:{m:65,a:4}, PA:{m:95,a:5}, RI:{m:99,a:5}, TX:{m:519,a:8}, VA:{m:2,a:2}, WI:{m:3,a:1}},
  ...
  "KMRA Group": {
    total:1163, uniqueAgents:11,
    states:["DE", "FL", "NJ", "PA", "TX"],
    bobState:{DE:{m:1,a:1}, FL:{m:9,a:4}, NJ:{m:449,a:8}, PA:{m:678,a:8}, TX:{m:26,a:1}},
  ...
  "Martell Multi": {
    total:1042, uniqueAgents:10,
    states:["NJ", "NY", "PA", "TX"],
    bobState:{NJ:{m:488,a:10}, NY:{m:1,a:1}, PA:{m:394,a:3}, TX:{m:159,a:2}},
  ...
  "TCS & Associates": {
    ...
    bobState:{FL:{m:316,a:6}, LA:{m:12,a:2}, NC:{m:34,a:2}, NJ:{m:31,a:6}, TX:{m:543,a:12}},
  ...
  "AMC Care Group": {
    ...
    bobState:{CA:{m:2,a:2}, CO:{m:34,a:1}, CT:{m:30,a:1}, FL:{m:4,a:1}, LA:{m:9,a:1}, MI:{m:22,a:1}, NC:{m:212,a:3}, NJ:{m:6,a:3}, NY:{m:15,a:2}, OH:{m:11,a:1}, PA:{m:40,a:2}, SC:{m:10,a:1}, TX:{m:335,a:4}},
  ...
  "Top Tier Health": {
    total:364, uniqueAgents:6,
    states:["DE", "FL", "NJ", "NY"],
    bobState:{DE:{m:13,a:2}, FL:{m:2,a:2}, NJ:{m:160,a:5}, NY:{m:189,a:6}},
    aps:{DE:2, NJ:5, NY:6},
  ...
  "JPM Solutions": {
    total:232, uniqueAgents:4,
    states:["AL", "DE", "FL", "NJ", "NY", "PA", "TX"],
    bobState:{AL:{m:12,a:2}, DE:{m:2,a:1}, FL:{m:13,a:2}, NJ:{m:104,a:3}, NY:{m:9,a:1}, PA:{m:60,a:1}, TX:{m:32,a:2}},
...
function BobBadge(){
  return(
    <div style={{display:"inline-flex",alignItems:"center",gap:5,background:"#1a0f2e",border:"1px solid #8b5cf655",borderRadius:6,padding:"4px 10px",fontSize:10,color:"#c4b5fd"}}>
      📊 <strong style={{color:"#a78bfa"}}>BOB REAL</strong>  ·  21,521 policies  ·  776 counties  ·  4,275 zips  ·  06-09-2026
    </div>
  );
}
      ...
      {open && (
        <div style={{position:"absolute",top:"calc(100% + 6px)",left:0,background:"#0c1222",border:"1px solid "+UHC_GOLD+"66",borderRadius:10,padding:8,minWidth:280,boxShadow:"0 24px 50px #00000099",zIndex:200}}>
          ...
          >
            ...
            <span style={{marginLeft:"auto",color:"#334155",fontSize:11}}>21,521 policies</span>
          </div>
          {agencies.map(a => (
            <div
              key={a.short}
        ...
        <div style={{background:"linear-gradient(135deg,#001a5e,#002677)",padding:"13px 15px",borderBottom:"2px solid "+mc}}>
          ...
          <div style={{marginTop:10,display:"inline-flex",alignItems:"center",gap:8,background:mc+"22",borderRadius:8,padding:"6px 12px",border:"1px solid "+mc+"44"}}>
            ...
            <div>
              ...
              <div style={{color:"#93c5fd",fontSize:10}}>{mode==="eligible"?"Source: CMS API 2024":"Source: ACM BOB 06-09-2026"}</div>
            </div>
          </div>
        </div>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
          <div style={{display:"flex",alignItems:"center",gap:18}}>
            ...
            <div>
              ...
              <p style={{margin:"3px 0 0",color:"#93c5fd",fontSize:11}}>State Director Presentation  ·  Medicare Advantage  ·  BOB as of 06-09-2026</p>
            </div>
          </div>
      ...
      <div style={{padding:"18px 24px"}}>
        ...
        {tab==="zip"&&(
          <div style={{background:"#0f172a",borderRadius:12,padding:18,border:"1px solid #1e293b"}}>
            ...
            <p style={{color:"#475569",fontSize:12,marginBottom:12}}>Top 20 zip codes per state  ·  Each zip shows its county  ·  Source: ACM_BOB_06-09-2026.xlsx</p>
        ...
        <div style={{marginTop:22,padding:"12px 0",borderTop:"1px solid #0f172a",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:6}}>
          <div style={{display:"flex",flexDirection:"column",gap:3}}>
            <span style={{color:"#94a3b8",fontSize:10}}>📊 BOB: ACM_BOB_06-09-26.xlsx  ·  21,521 active policies  ·  776 counties  ·  134 agents  ·  22 states</span>
